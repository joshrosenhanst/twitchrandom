...
@section('meta')
    <meta name="description" content="We need slogans! Got any ideas? Find something unexpected at https://twitchrandom.com!">
@stop
        ...
        <form class="slogan-form" method="POST">
            <div class="form-group">
                ...
                <div class="input-group input-group-lg">
                    <input type="text" class="form-control" id="slogan" name="slogan" placeholder="{{ $random_text }}" maxlength="50" required>
                    <div class="input-group-btn dropup">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right" id="dropdown-emotes">
                            @foreach($emote_list as $name=>$value)
                                <li><a href="#" data-shortcode-name="{{ $name }}" title="{{ $name }}"><img src="https://static-cdn.jtvnw.net/emoticons/v1/{{ $value->image_id }}/1.0"></a>
                                </li>
                            @endforeach
                        </ul>
                    </div>
