...
class Twitch {
     ...
     * @return  stdClass
     */
    public function getRandomStreams($game = null, $limit = null, $offset = null, $channels = null, $embeddable = null, $hls = null, $broadcaster_language = null)
    {
        $params = array(
          'game' => $game,
          'limit' => $limit,
        ...
        return $this->request(self::URI_STREAM_RANDOM . $query_string);
    }
